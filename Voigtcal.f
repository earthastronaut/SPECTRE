      double precision function voigtcal (a,v)                                                
c******************************************************************************
...
c     landolt-bornstein.    
c     For SPECTRE, we use the unnormalized H, not U
c******************************************************************************
...
c  case 1, a .gt. 1.4 or (a .gt. 0.2 and a+v .gt. 3.2)                   
      u = 1.4142136*(a2 + v2)                                            
      voigtcal = 0.7978847*a/u*(1.0 + (3.0*v2-a2)/u**2 + (15.0*v2*v2        
...
36    h2 = (1.0 - 2.0*v2)*h0                                             
      ...
      voigtcal = u*(h0 + h1*a + h2*a2 + h3*a*a2 + h4*a2*a2)                 
      return                                                             
c  case 3,  a .le. 0.2 and v .lt. 5.0                                    
50    if(v .ge. 5.0) go to 60                                            
      go to 31                                                           
52    voigtcal = h0 + h1*a + h2*a2                                          
      return                                                             
c  case 4,  a .le. 0.2 and v .ge. 5.0                                    
60    voigtcal = a/(1.772454*v2)*(1.0 + 1.5/v2 + 3.75/(v2*v2))              
      return                                                             
c  case 5, a .eq. 0.0                                                    
62    voigtcal = dexp(-v2)
      return                                                             
